...
import React__default, { useRef, useCallback, useEffect, createElement, PureComponent, useReducer, useLayoutEffect } from 'react';
import { Droppable, Draggable as Draggable$3, DragDropContext } from 'react-beautiful-dnd';
...
var Resizable = /** @class */ (function (_super) {
    ...
    Resizable.prototype.render = function () {
        ...
        return (React$1.createElement(Wrapper, __assign$1({ ref: this.ref, style: style, className: this.props.className }, extendsProps),
...
var useBlockInputStore = function () {
    ...
    return React$1.useContext(context).apply(void 0, args);
};
function BlockEditorContext(_a) {
    var children = _a.children;
    var useStore = React$1.useState(function () { return create(blockEditorStore); })[0];
    return React$1.createElement(context.Provider, { value: useStore }, children);
}

var ChevronUp = function (props) {
    return (React$1.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "3", strokeLinecap: "round", strokeLinejoin: "round", className: props.className },
        React$1.createElement("polyline", { points: "18 15 12 9 6 15" })));
};
var ChevronDown = function (props) {
    return (React$1.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "3", strokeLinecap: "round", strokeLinejoin: "round", className: props.className },
        React$1.createElement("polyline", { points: "6 9 12 15 18 9" })));
};
var Trash = function (props) {
    return (React$1.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: props.className },
        ...
        React$1.createElement("line", { x1: "10", y1: "11", x2: "10", y2: "17" }),
        React$1.createElement("line", { x1: "14", y1: "11", x2: "14", y2: "17" })));
};
var Move = function (props) {
    return (React$1.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: props.className },
        React$1.createElement("polyline", { points: "5 9 2 12 5 15" }),
        React$1.createElement("polyline", { points: "9 5 12 2 15 5" }),
        React$1.createElement("polyline", { points: "15 19 12 22 9 19" }),
        React$1.createElement("polyline", { points: "19 9 22 12 19 15" }),
        React$1.createElement("line", { x1: "2", y1: "12", x2: "22", y2: "12" }),
        React$1.createElement("line", { x1: "12", y1: "2", x2: "12", y2: "22" })));
};
...
var Search = function (props) {
    return (React$1.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: props.className },
...
var SettingsPanel = React$1.memo(function SettingsPanel(props) {
    var _a;
    ...
    var title = React$1.useMemo(function () {
        var _a;
        if (!blockMeta)
            return null;
    ...
    return (React$1.createElement("aside", { className: clsx("bg-gray-50 flex-0 p-2 overflow-auto max-h-[80vh]", fixedSettingsPanel ? "w-[340px] xl:w-[400px]" : "w-0") },
        settingsMeta ? (React$1.createElement(SettingsWrapper, { id: (blockMeta === null || blockMeta === void 0 ? void 0 : blockMeta.id) + "/" + settingsMeta.props.source, height: "auto" },
            React$1.createElement("header", { className: "text-white bg-purple-600 cursor-move dragHandle p-1 pl-2 flex-none h-8 flex items-center justify-between" },
                React$1.createElement("section", { className: "truncate" }, (_a = settingsMeta.props.label) !== null && _a !== void 0 ? _a : settingsMeta.props.source),
                React$1.createElement("aside", { className: "flex items-center justify-center" },
                    React$1.createElement("button", { className: "btn btn-xs bg-transparent border-none", onClick: handleToggleFixedSidebar },
                        React$1.createElement(ChevronDown, { className: clsx("w-4 text-white transform", fixedSettingsPanel ? "rotate-90" : "-rotate-90"), label: "Move to sidebar" })),
                    React$1.createElement("button", { className: "btn btn-xs bg-transparent border-none", onClick: handleCloseInput },
                        React$1.createElement(Close, { className: "w-4 text-white", label: "Close" })))),
            React$1.createElement("section", { className: "overflow-auto p-2 h-[calc(100%-2rem)] bg-gray-50" },
                React$1.createElement(settingsMeta.Component, __assign$3({}, settingsMeta.props))))) : null,
        blockMeta && blockMeta.withSettings ? (React$1.createElement(SettingsWrapper, { id: blockMeta.id },
            React$1.createElement("header", { className: "text-white bg-blue-800 cursor-move dragHandle p-1 pl-2 flex-none h-8 flex items-center justify-between" },
                React$1.createElement("section", { className: "truncate" }, title !== null && title !== void 0 ? title : "Nastavení stránky"),
                React$1.createElement("aside", { className: "flex items-center justify-center" },
                    React$1.createElement("button", { className: "btn btn-xs bg-transparent border-none", onClick: handleToggleFixedSidebar },
                        React$1.createElement(ChevronDown, { className: clsx("w-4 text-white transform", fixedSettingsPanel ? "rotate-90" : "-rotate-90"), label: "Move to sidebar" })),
                    React$1.createElement("button", { className: "btn btn-xs bg-transparent border-none", onClick: handleClose },
                        React$1.createElement(Close, { className: "w-4 text-white", label: "Close" })))),
            React$1.createElement("section", { className: "overflow-auto p-2 h-[calc(100%-2rem)] bg-gray-50" },
                React$1.createElement(ErrorBoundary, { fallbackRender: function (_a) {
                        var error = _a.error, resetErrorBoundary = _a.resetErrorBoundary;
                        return (React$1.createElement("div", { role: "alert" },
                            React$1.createElement("div", null, "Oh no"),
                            React$1.createElement("div", null, error.message),
                            React$1.createElement("button", { className: "btn", onClick: function () {
                                    resetErrorBoundary();
                                } }, "Try again")));
                    } }, blockMeta ? React$1.createElement(LazySettings, { blockMeta: blockMeta }) : null)))) : null));
}, reactFastCompare);
var SettingsWrapper = React$1.memo(function (props) {
    var _a;
    var fixedSettingsPanel = useBlockEditorStore(function (state) { return [
        state.fixedSettingsPanel,
    ]; })[0];
    if (fixedSettingsPanel) {
        return React$1.createElement(React$1.Fragment, null, props.children);
    }
    return (React$1.createElement(Rnd, { key: props.id, className: "flex flex-col border border-gray-300 rounded shadow-lg bg-white z-[99999] overflow-hidden", enableUserSelectHack: false, dragHandleClassName: "dragHandle", minWidth: 300, minHeight: 100, maxHeight: "60vh", maxWidth: 600, default: {
            x: -480,
            y: window.scrollY + 50,
            width: 400,
...
var LazyloadComponent = function (componentPath) {
    return function (props) {
        ...
        var _a = React$1.useState(null), ComponentContainer = _a[0], setComponentContainer = _a[1];
        React$1.useEffect(function () {
            if (componentPath) {
                var path_1 = componentPath();
                setComponentContainer(React$1.lazy(function () { return path_1; }));
            }
        }, [componentPath]);
        return (React$1.createElement(React$1.Suspense, { fallback: React$1.createElement("div", null, "Loading") }, ComponentContainer ? React$1.createElement(ComponentContainer, __assign$3({}, props)) : null));
    };
};
var LazySettings = React$1.memo(function LazySettings(props) {
    var tools = useBlockInputStore(function (state) { return state.tools; }, reactFastCompare);
    var Settings = React$1.useMemo(function () { var _a; return LazyloadComponent((_a = tools[props.blockMeta.type]) === null || _a === void 0 ? void 0 : _a.Settings); }, [props.blockMeta.id]);
    // console.log("LazySettings render", props.blockMeta, Settings)
    if (props.blockMeta && Settings) {
        return (React$1.createElement(Settings, { blockID: props.blockMeta.id, source: props.blockMeta.source, getSource: function (scopedSource) {
...
var ToolsPanel = React$1.memo(function ToolsPanel(props) {
    ...
    return (React$1.createElement("aside", { className: clsx("top-0 w-48 bg-gray-100 py-2 absolute h-full overflow-auto ease-in-out transition-all duration-300 z-[99999]", toolbarOpen ? "left-0" : "-left-48") },
        React$1.createElement("header", { className: "text-center text-sm group-hover:underline" }, "Bloky"),
        React$1.createElement(ToolsListWithFilter, { tools: tools })));
});
var ToolsListWithFilter = function (props) {
    var _a = React$1.useState(""), selectedTag = _a[0], setSelectedTag = _a[1];
    return (React$1.createElement("section", null,
        React$1.createElement(TagFilter, { tools: props.tools, selectedTag: selectedTag, setSelectedTag: setSelectedTag }),
        React$1.createElement(Droppable, { droppableId: "sidebar" }, function (provided, snapshot) { return (React$1.createElement("section", __assign$3({ ref: provided.innerRef }, provided.droppableProps), props.tools
            ? props.tools.map(function (tool, index) {
                ...
                return (React$1.createElement(ToolsItem, { index: index, block: tool, key: tool.type + "-" + index }));
            })
            : null)); })));
};
var ToolsItem = function (props) {
    return (React$1.createElement("article", { className: "m-4" },
        React$1.createElement(Draggable$3, { draggableId: props.block.type, index: props.index }, function (provided, snapshot) {
            var _a, _b, _c;
            return (React$1.createElement("article", __assign$3({ className: "bg-white shadow-xl rounded p-1", ref: provided.innerRef }, provided.draggableProps, provided.dragHandleProps),
                React$1.createElement("header", { className: "text-center text-sm" },
                    props.block.type, (_b = (_a = props.block) === null || _a === void 0 ? void 0 : _a.title) !== null && _b !== void 0 ? _b : props.block.type),
                ((_c = props.block) === null || _c === void 0 ? void 0 : _c.previewImage) ? (React$1.createElement("img", { src: props.block.previewImage })) : null));
        })));
};
var TagFilter = function (props) {
    var _a = React$1.useState(false), inputActive = _a[0], setInputActive = _a[1];
    var _b = React$1.useState([]), tags = _b[0], setTags = _b[1];
    ...
    return (React$1.createElement("aside", { className: "px-2" },
        React$1.createElement("header", { className: "flex items-center overflow-hidden" },
            React$1.createElement("button", { onClick: handleFocus, className: "btn btn-xs btn-outline border-none m-0.5 italic opacity-75 flex-none" },
                React$1.createElement(Search, { className: "w-4 h-4" }),
                !props.selectedTag ? React$1.createElement("span", { className: "ml-1" }, "Filtrovat") : null),
            props.selectedTag ? (React$1.createElement(TagButton, { tag: props.selectedTag, onClick: handleSelected, selected: true })) : null),
        React$1.createElement("section", { className: "relative" }, inputActive ? (React$1.createElement("section", { className: "absolute top-0 -left-1 bg-white shadow rounded pb-0.5 px-0.5", ref: ref }, tags.map(function (tag) {
            return React$1.createElement(TagButton, { tag: tag, key: tag, onClick: handleSelected });
        }))) : null)));
};
var TagButton = function (props) {
    ...
    return (React$1.createElement("button", { onClick: handleClick, "data-tag": props.tag, className: clsx("btn btn-xs h-auto m-0.5 inline-flex flex-nowrap items-center flex-shrink", props.selected ? "" : "btn-outline") },
        props.selected ? (React$1.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", className: "inline-block w-3 h-3 mr-1 stroke-current" },
            React$1.createElement("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M6 18L18 6M6 6l12 12" }))) : null,
        React$1.createElement("span", { className: "overflow-ellipsis" }, props.tag)));
};
...
var useThrottle = function (cb, delay) {
    ...
    var cbRef = React$1.useRef(cb);
    // use mutable ref to make useCallback/throttle not depend on `cb` dep
    React$1.useEffect(function () {
        cbRef.current = cb;
    });
    return React$1.useCallback(throttle_1(function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
...
var t=React__default["undefined"!=typeof document&&void 0!==document.createElement?"useLayoutEffect":"useEffect"];var t$1 = t;

var n = e=>{var a=useRef(e);return useEffect(()=>{a.current=e;}),a};
...
var PagePanel = React$1.memo(function PagePanel(props) {
    ...
    return (React$1.createElement(Droppable, { droppableId: "page" }, function (provided, snapshot) { return (React$1.createElement("section", __assign$3({ id: "page-wrapper" }, provided.droppableProps, { ref: provided.innerRef, className: clsx("relative min-h-[150px] w-full border border-gray-200 bg-white") }), blocks === null || blocks === void 0 ? void 0 :
        blocks.map(function (block, index) {
            return (React$1.createElement(PageBlock, { block: block, index: index, key: "block-" + block.id }));
        }),
        provided.placeholder,
        React$1.createElement(HoverHighlightNode, null),
        React$1.createElement(SelectedHighlightNode, null))); }));
});
var MissingBlock = function (props) {
    return (React$1.createElement("main", { className: "py-4 flex items-center justify-center" },
        React$1.createElement("p", { className: "border border-red-500 p-4 rounded" },
            "Missing block type \"", props === null || props === void 0 ? void 0 :
            props.type,
            "\"")));
};
var PageBlock = React$1.memo(function PageBlock(props) {
    var _a, _b;
    var _c = useBlockInputStore(function (state) { return [
        state.setSelected,
    ...
    return (React$1.createElement(Draggable$3, { draggableId: props.block.id, index: props.index }, function (provided, snapshot) { return (React$1.createElement("section", __assign$3({ ref: provided.innerRef }, provided.draggableProps, { className: clsx("relative"), onClick: handleClick, "data-block-type": props.block.type, "data-block-id": props.block.id }),
        permissions.includes("compose") ? (React$1.createElement("aside", { className: clsx("absolute -top-3 right-1 z-[9999]", isSelected ? "block" : "hidden") },
            React$1.createElement("section", { className: "btn-group" },
                React$1.createElement("button", { className: "btn btn-xs", onClick: handleMoveUp },
                    React$1.createElement(ChevronUp, { className: "w-4", label: "Move up" })),
                React$1.createElement("button", { className: "btn btn-xs", onClick: handleMoveDown },
                    React$1.createElement(ChevronDown, { className: "w-4", label: "Move up" })),
                React$1.createElement("div", __assign$3({ className: "btn btn-xs" }, provided.dragHandleProps),
                    React$1.createElement(Move, { className: "w-4", label: "Move up" })),
                React$1.createElement("button", { className: "btn btn-xs", onClick: handleDelete },
                    React$1.createElement(Trash, { className: "w-4", label: "Move up" }))))) : null,
        React$1.createElement("div", { className: "pointer-events-none" },
            React$1.createElement(ErrorBoundary, { FallbackComponent: function (_a) {
                    var error = _a.error, resetErrorBoundary = _a.resetErrorBoundary;
                    return (React$1.createElement("div", { role: "alert" },
                        React$1.createElement("div", null, "Oh no"),
                        React$1.createElement("div", { className: "break-words" }, error.message),
                        React$1.createElement("button", { onClick: function () {
                                // though you could accomplish this with a combination
                                // of the FallbackCallback and onReset props as well.
                                resetErrorBoundary();
                            } }, "Try again")));
                } },
                React$1.createElement(Block, __assign$3({}, blockProps)))))); }));
});
var HighlightInput = function (props) {
    ...
    var pageWrapperRef = React$1.useRef(null);
    var selectedRef = React$1.useRef(null);
    React$1.useEffect(function () {
    ...
    return (React$1.createElement("aside", { onClick: handleOpenSettings, className: clsx("absolute border-[2px] border-purple-300 hover:border-solid", isSelected ? "border-solid" : "border-dashed"), style: __assign$3({ zIndex: 999 }, computedStyle) },
        React$1.createElement("section", { className: clsx("absolute top-0 left-[-2px] -translate-y-full rounded-tl rounded-tr text-white text-xs px-1 py-0.5 flex items-center group", isSelected ? "bg-purple-600" : "bg-purple-400") },
            settings.label,
            " - ",
            settings.source,
            "@",
            settings.settings,
            isSelected ? (React$1.createElement("button", { className: "bg-transparent border-none group hover:bg-gray-800 rounded-full h-3 inline-flex justify-center items-center ml-1", onClick: handleCloseInput },
                React$1.createElement(Close, { className: "w-3 text-white", label: "Close" }))) : null)));
};
var withCurrentRecord = function (Component) {
    var values = useFormState().values;
    return function (props) {
        return React$1.createElement(Component, __assign$3({}, props, { record: values }));
    };
};
...
var SelectedHighlightNode = function (props) {
    ...
    var _c = React$1.useState(""), blockType = _c[0], setBlockType = _c[1];
    var _d = React$1.useState([]), selectedInputs = _d[0], setSelectedInputs = _d[1];
    var _e = React$1.useState({}), computedStyle = _e[0], setComputedStyle = _e[1];
    var pageRef = React$1.useRef(null);
    var blockRef = React$1.useRef(null);
    var handleClose = function (e) {
        handlePrevent(e);
        setSelected(null);
    };
    ...
    return (React$1.createElement(React$1.Fragment, null,
        React$1.createElement("aside", { className: "absolute border-[2px] border-yellow-300 pointer-events-none", style: __assign$3({ zIndex: 999 }, computedStyle) },
            React$1.createElement("section", { className: "absolute top-0 left-[-2px] -translate-y-full bg-yellow-300 rounded-tl rounded-tr text-xs px-1 py-0.5 flex items-center pointer-events-auto" }, (_a = tool === null || tool === void 0 ? void 0 : tool.title) !== null && _a !== void 0 ? _a : tool === null || tool === void 0 ? void 0 : tool.type,
                React$1.createElement("button", { className: "bg-transparent border-none group hover:bg-gray-800 rounded-full h-3 inline-flex justify-center items-center ml-1", onClick: handleClose },
                    React$1.createElement(Close, { className: "w-3 text-black group-hover:text-white", label: "Close" })))),
        selectedInputs.map(function (input) {
            return React$1.createElement(HighlightInput, { input: input });
        })));
};
var HoverHighlightNode = function (props) {
    var _a;
    var tools = useBlockInputStore(function (state) { return [state.tools]; }, reactFastCompare)[0];
    var _b = React$1.useState({}), computedStyle = _b[0], setComputedStyle = _b[1];
    var _c = React$1.useState(""), blockType = _c[0], setBlockType = _c[1];
    var pageWrapperRef = React$1.useRef(null);
    ...
    var tool = tools.find(function (tool) { return tool.type === blockType; });
    return (React$1.createElement("aside", { className: "absolute border-[2px] border-yellow-300 border-dashed pointer-events-none", style: __assign$3({ zIndex: 999 }, computedStyle) },
        React$1.createElement("section", { className: "absolute top-0 left-[-2px] -translate-y-full bg-yellow-300 rounded-tl rounded-tr text-xs px-1 py-0.5 flex items-center" }, (_a = tool === null || tool === void 0 ? void 0 : tool.title) !== null && _a !== void 0 ? _a : tool === null || tool === void 0 ? void 0 : tool.type)));
};
var useBoundingBox = function (target) {
    var _a = React$1.useState(), bb = _a[0], setBB = _a[1];
    React$1.useLayoutEffect(function () {
...
var BlockEditor = function (props) {
    var editorRef = React$1.useRef(null);
    var isVisible = useOnScreen(editorRef);
    console.log("BlockEditor isVisible", isVisible);
    return (React$1.createElement("main", { ref: editorRef }, isVisible ? (React$1.createElement(BlockEditorContext, null,
        React$1.createElement(BlockEditorInstance, __assign$3({}, props)))) : null));
};
var BlockEditorInstance = React$1.memo(function BlockEditorInstance(props) {
    var _a = useBlockInputStore(function (state) { return [
        state.addBlock,
        state.moveBlock,
        state.setSelected,
    ...
    return (React$1.createElement("main", { className: "border border-gray-200 rounded relative overflow-hidden" },
        React$1.createElement(DragDropContext, { onDragStart: handleDragStart, onDragEnd: handleDragEnd },
            React$1.createElement("header", { className: "w-full h-8 bg-gray-50 flex justify-start items-center px-1" }, permissions.includes("add") ? (React$1.createElement("button", { className: "btn btn-outline btn-xs", onClick: handleAdd }, "+ P\u0159idat blok")) : null),
            React$1.createElement(ToolsPanel, null),
            React$1.createElement("section", { className: "flex" },
                React$1.createElement("section", { className: "bg-gray-300 flex-1 overflow-auto p-6 relative" },
                    React$1.createElement(PagePanel, null)),
                React$1.createElement(SettingsPanel, null)))));
}, reactFastCompare);
